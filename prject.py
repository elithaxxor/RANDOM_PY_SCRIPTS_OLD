...
# Application layout
app.layout = html.Div(children=[html.HI(children=' Domestic Airline Flights Performance.') style={'textAlign': 'center', 'color': '#503D36', 'font-size': 24}
...
app = dash.Dash(__name__, external_stylesheets=external_stylesheets) ### to do 2

app.layout = html.Div([
    dcc.Dropdown(
        id='demo-dropdown',
        options=[ # ADD PLACEHOLDER
            {'Yearly Airline Performance Report': 'New York City', 'value': 'OP2'}, Yearly Airline Performance Report
            {'Yearly Airline Delay Report': 'Montreal', 'value': 'OPT2'},
        ],
          ],
