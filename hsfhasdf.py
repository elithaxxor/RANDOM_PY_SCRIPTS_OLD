...
start_server = f'[+] [SERVER RECEIVING NEW CLIENT] [+] \n-- [Choose a Screenname] \n[{addr}:{sock}] [{time.ctime}]'
start_server.encode(encoding='utf-8')
payload_size = struct.calcsize("Q")
print(payload_size)

if start_server > payload_size:
    print("start_server > payload_size")
else:
    print("payload_size < start_server")
